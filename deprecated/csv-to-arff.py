...
fileToRead = "csvOutput/file.csv"  # csv file name or absolute path to be open.
fileToWrite = "csvOutput/file.arff"  # name as how you'll save your arff file.
relation = "MDAD 2014"  # how you'll like to call your relation as.
